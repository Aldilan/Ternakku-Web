...
<body class="bg-gradient-success">
    ...
    <div class="container TernakKu-card">
        ...
        <div class="row justify-content-center my-5 mx-5">
            ...
            <div class="col-lg-12 col-md-9 my-5">

                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0 my-5">

                        <div class="row">
                            <img class="w-50"src="img/Group 261.svg" />

                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">TernakKu Admin</h1>
                                    </div>
                                    <form class="user" method="post" action="{{ url('auth/') }}">
                                        ...
                                        <button type="submit" class="btn bg-success text-white btn-user btn-block">
                                            Login
                                        </button>
                                    </form>
